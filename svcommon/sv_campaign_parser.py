...
class SvCampaignParser(sv_object.ISvObject):
    ...
    __g_dictSourceMediumType = {
        ...
        34: {'title': 'IG_CPC', 'media_rst_type': 'PS', 'media_source': 'instagram',
             'media_media': 'cpc', 'desc': '인스타그램 광고', 'camp_prefix': 'IG_PS_CPC_'},
        35: {'title': 'IG_DISP', 'media_rst_type': 'PS', 'media_source': 'facebook',
             'media_media': 'display', 'desc': '인스타그램 광고', 'camp_prefix': 'IG_PS_DISP_'},
        36: {'title': 'FBIG_PNS', 'media_rst_type': 'PS', 'media_source': 'facebook',
             'media_media': 'organic', 'desc': '페북 인스타 유료 자연검색 광고', 'camp_prefix': 'FBIF_PNS_REF_'},
    ...
    def parse_campaign_code(self, s_sv_campaign_code=''):
        ...
        for s_campaign_prefix in self.__g_lstLatestSvCampaignPrefix:
            if s_campaign_prefix is None:  # None is added onto __g_lstLatestSvCampaignPrefix while running by chance if construct list dynamically
                continue
