...
class SvHypermartGeoInfo():
    lst_hypermart_geo_info = [
        ...
        {'id': 274, 'hypermart_name': 'Lottemart', 'branch_code': '802', 'name': '춘천점', 'branch_type': 'Offline', 'do_name': '강원도', 'si_name': '춘천시', 'gu_gun': None, 'dong_myun_ri': '온의동', 'latitude': '37.863871', 'longitude': '127.718627'},
        ...
        # Newly emerged uplicated branch info after Emart EDI service update
        {'id': 301, 'hypermart_name': 'Emart', 'branch_code': '1005', 'name': 'EM남원점', 'branch_type': 'Offline', 'do_name': '전라북도', 'si_name': '남원시', 'gu_gun': '남문로', 'dong_myun_ri': None, 'latitude': '35.408049', 'longitude': '127.375068'},
        {'id': 302, 'hypermart_name': 'Emart', 'branch_code': '1053', 'name': 'EM영천점', 'branch_type': 'Offline', 'do_name': '경상북도', 'si_name': '영천시', 'gu_gun': None, 'dong_myun_ri': '오수동', 'latitude': '35.958708', 'longitude': '128.910082'},
        {'id': 303, 'hypermart_name': 'Emart', 'branch_code': '1004', 'name': 'EM제주점', 'branch_type': 'Offline', 'do_name': '제주특별자치도', 'si_name': '제주시', 'gu_gun': None, 'dong_myun_ri': '삼도이동', 'latitude': '33.518195', 'longitude': '126.521227'},
        {'id': 304, 'hypermart_name': 'Emart', 'branch_code': '1012', 'name': 'EM구로점', 'branch_type': 'Offline', 'do_name': '서울', 'si_name': '서울특별시', 'gu_gun': '구로구', 'dong_myun_ri': '구로동', 'latitude': '37.484538', 'longitude': '126.897945'},
        {'id': 305, 'hypermart_name': 'Emart', 'branch_code': '1043', 'name': 'EM강릉점', 'branch_type': 'Offline', 'do_name': '강원도', 'si_name': '강릉시', 'gu_gun': '송정동', 'dong_myun_ri': '경강로', 'latitude': '37.770748', 'longitude': '128.922616'},
        {'id': 306, 'hypermart_name': 'Emart', 'branch_code': '1045', 'name': 'EM문현점', 'branch_type': 'Offline', 'do_name': '부산', 'si_name': '부산광역시', 'gu_gun': '남구', 'dong_myun_ri': '문현동', 'latitude': '35.144544', 'longitude': '129.064205'},
        {'id': 307, 'hypermart_name': 'Emart', 'branch_code': '1066', 'name': 'EM춘천점', 'branch_type': 'Offline', 'do_name': '서울', 'si_name': '서울특별시', 'gu_gun': '강남구', 'dong_myun_ri': '역삼동', 'latitude': '37.49934', 'longitude': '127.04853'},
        {'id': 308, 'hypermart_name': 'Emart', 'branch_code': '1112', 'name': 'EM광명소하점', 'branch_type': 'Offline', 'do_name': '경기도', 'si_name': '광명시', 'gu_gun': None, 'dong_myun_ri': '소하동', 'latitude': '37.446863', 'longitude': '126.884608'},
        {'id': 309, 'hypermart_name': 'Emart', 'branch_code': '1131', 'name': 'EM김포한강점', 'branch_type': 'Offline', 'do_name': '경기도', 'si_name': '김포시', 'gu_gun': '구래동', 'dong_myun_ri': None, 'latitude': '37.644631', 'longitude': '126.628289'},
        {'id': 310, 'hypermart_name': 'Emart', 'branch_code': '1998', 'name': 'EMFC부천점', 'branch_type': 'Offline', 'do_name': '경기도', 'si_name': '부천시', 'gu_gun': None, 'dong_myun_ri': '심곡본동', 'latitude': '37.484268', 'longitude': '126.782665'},
        {'id': 311, 'hypermart_name': 'Emart', 'branch_code': '1002', 'name': 'EM일산점', 'branch_type': 'Offline', 'do_name': '경기도', 'si_name': '고양시', 'gu_gun': '일산동구', 'dong_myun_ri': '백석동', 'latitude': '37.648015', 'longitude': '126.782407'},
        {'id': 312, 'hypermart_name': 'Emart', 'branch_code': '1031', 'name': 'EM충주점', 'branch_type': 'Offline', 'do_name': '충청북도', 'si_name': '충주시', 'gu_gun': None, 'dong_myun_ri': '문화동', 'latitude': '36.972634', 'longitude': '127.923362'},
        {'id': 313, 'hypermart_name': 'Emart', 'branch_code': '1122', 'name': 'EM동구미점', 'branch_type': 'Offline', 'do_name': '경상북도', 'si_name': '구미시', 'gu_gun': None, 'dong_myun_ri': '임수동', 'latitude': '36.106493', 'longitude': '128.404166'},
        {'id': 314, 'hypermart_name': 'Emart', 'branch_code': '1130', 'name': 'EM풍산점', 'branch_type': 'Offline', 'do_name': '경기도', 'si_name': '고양시', 'gu_gun': '일산동구', 'dong_myun_ri': '풍동', 'latitude': '37.673796', 'longitude': '126.786752'},
        {'id': 315, 'hypermart_name': 'Emart', 'branch_code': '1999', 'name': 'EMFC안양점', 'branch_type': 'Offline', 'do_name': '경기도', 'si_name': '안양시', 'gu_gun': '동안구', 'dong_myun_ri':'비산동', 'latitude': '37.398572', 'longitude': '126.935213'},
        {'id': 317, 'hypermart_name': 'Emart', 'branch_code': '8000', 'name': 'EMEO.S청계천(B1)', 'branch_type': 'Offline', 'do_name': '서울', 'si_name': '서울특별시', 'gu_gun': '중구', 'dong_myun_ri': '황학동', 'latitude': '37.571202', 'longitude': '127.022977'},
        {'id': 318, 'hypermart_name': 'Emart', 'branch_code': '5304', 'name': '몰리스STF하남점', 'branch_type': 'Offline', 'do_name': '경기도', 'si_name': '하남시', 'gu_gun': None, 'dong_myun_ri': '신장동', 'latitude': '37.5454092', 'longitude': '127.223737'},
        {'id': 319, 'hypermart_name': 'Emart', 'branch_code': '5303', 'name': '몰리스센텀점', 'branch_type': 'Offline', 'do_name': '부산', 'si_name': '부산광역시', 'gu_gun': '해운대구', 'dong_myun_ri': '우동', 'latitude': '35.1698887', 'longitude': '129.128295'},
        {'id': 320, 'hypermart_name': 'Emart', 'branch_code': '5301', 'name': '몰리센트럴시티', 'branch_type': 'Offline', 'do_name': '서울', 'si_name': '서울특별시', 'gu_gun': '서초구', 'dong_myun_ri': '반포동', 'latitude': '37.5043439', 'longitude': '127.003599'},
        {'id': 321, 'hypermart_name': 'Emart', 'branch_code': '5307', 'name': '몰리스STF고양점', 'branch_type': 'Offline', 'do_name': '경기도', 'si_name': '고양시', 'gu_gun': '덕양구', 'dong_myun_ri': '동산동', 'latitude': '37.6476807', 'longitude': '126.896455'},
        {'id': 322, 'hypermart_name': 'Emart', 'branch_code': '5308', 'name': '몰리스STF위례점', 'branch_type': 'Offline', 'do_name': '경기도', 'si_name': '하남시', 'gu_gun': None, 'dong_myun_ri': '학암동', 'latitude': '37.4801236', 'longitude': '127.148382'},
        {'id': 323, 'hypermart_name': 'Emart', 'branch_code': '5309', 'name': '몰리스STF부천옥길점', 'branch_type': 'Offline', 'do_name': '경기도', 'si_name': '부천시', 'gu_gun': None, 'dong_myun_ri': '옥길동', 'latitude': '37.4615688', 'longitude': '126.813955'},
        {'id': 324, 'hypermart_name': 'Emart', 'branch_code': '5310', 'name': '몰리스STF안성점', 'branch_type': 'Offline', 'do_name': '경기도', 'si_name': '안성시', 'gu_gun': None, 'dong_myun_ri': '진사리', 'latitude': '36.9943473', 'longitude': '127.147307'},
        {'id': 325, 'hypermart_name': 'Emart', 'branch_code': '5901', 'name': '쓱고우논현점', 'branch_type': 'Offline', 'do_name': '서울', 'si_name': '서울특별시', 'gu_gun': '강남구', 'dong_myun_ri': '논현동', 'latitude': '37.5078828', 'longitude': '127.023324'},
        {'id': 326, 'hypermart_name': 'Emart', 'branch_code': '5902', 'name': '쓱고우역삼점', 'branch_type': 'Offline', 'do_name': '서울', 'si_name': '서울특별시', 'gu_gun': '강남구', 'dong_myun_ri': '역삼동', 'latitude': '37.49934', 'longitude': '127.04853'},
        {'id': 327, 'hypermart_name': 'Emart', 'branch_code': '8502', 'name': 'EM김포몰가상점', 'branch_type': 'Online', 'do_name': '온라인', 'si_name': '온라인', 'gu_gun': '온라인', 'dong_myun_ri': '온라인', 'latitude': None, 'longitude': None},
        {'id': 328, 'hypermart_name': 'Emart', 'branch_code': '8503', 'name': 'EM보정몰가상점', 'branch_type': 'Online', 'do_name': '온라인', 'si_name': '온라인', 'gu_gun': '온라인', 'dong_myun_ri': '온라인', 'latitude': None, 'longitude': None},
        ...
        {'id': 333, 'hypermart_name': 'Emart', 'branch_code': '5311', 'name': '몰리스STF수원점', 'branch_type': 'Offline', 'do_name': '경기도', 'si_name': '수원시', 'gu_gun': '권선구', 'dong_myun_ri': '권선2동', 'latitude': '37.250093', 'longitude': '127.021549'},
    ]
