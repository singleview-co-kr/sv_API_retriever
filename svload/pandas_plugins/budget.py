...
class Budget:
    ...
    def get_budget_amnt_by_period(self, dt_start, dt_end):
        ...
        if lst_budget_forward_rst and 'err_code' in lst_budget_forward_rst.pop().keys():  # for an initial stage; no table
        ...
        if lst_budget_backward_rst and 'err_code' in lst_budget_backward_rst.pop().keys():  # for an initial stage; no table
