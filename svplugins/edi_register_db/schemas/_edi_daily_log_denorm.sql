CREATE TABLE `{{brand_id}}_edi_daily_log_denorm` (
  ...
  `amnt` int DEFAULT 0,
  `do` varchar(100) COLLATE utf8_bin NOT NULL,
  `si` varchar(100) COLLATE utf8_bin NOT NULL,
  `gu` varchar(100) COLLATE utf8_bin NULL,
  `dong` varchar(100) COLLATE utf8_bin NULL,
